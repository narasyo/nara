...
for N,n1 in tqdm(zip(Number,[2])) :
    ...
    # fig1.tight_layout()
    # fig1.savefig("{a}_{b}_freq<={c}Hz_F{d}.png".format(a=date_input,b=direction_input,c=freq_init,d=str_n1))
    # plt.clf()
    # plt.close()
    ...
    #     fig2.tight_layout()
    #     fig2.savefig("{a}_{b}_{F1}Hz<=freq<={F2}Hz_F{c}.png".format(a=date_input,b=direction_input,F1=f1,F2=f2,c=str_n1))
    #     plt.clf()
    #     plt.close()
