...
class Format:
    def params():
            ...
            ## Figureの設定 ##
            plt.rcParams['figure.figsize'] = (50,15)  # figure size in inch, 横×縦
            ...
            ## Axesの設定 ##
            plt.rcParams["font.size"] = 100  # 全体のフォントサイズが変更されます
            plt.rcParams['xtick.labelsize'] = 100  # 軸だけ変更されます
            plt.rcParams['ytick.labelsize'] = 100  # 軸だけ変更されます
            ...
            plt.rcParams['lines.linewidth'] = 2 #グラフの線の太さ

            ## グリッドの設定 ##
            plt.rcParams['axes.grid'] = True # グリッドがあるかどうか，Trueあり，Falseなし
            plt.rcParams["grid.linewidth"] = 3.0        # グリッドの線幅
